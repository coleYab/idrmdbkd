...
import { DisasterSeverityLevel, DisasterStatus } from '../../../shared/enums/disaster.enums';
...
export interface DisasterRepository {
  ...
  findByFilters(filter: { statuses?: DisasterStatus[]; severities?: DisasterSeverityLevel[] }): Promise<Disaster[]>;
